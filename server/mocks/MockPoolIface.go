...
// MockPoolIface is an autogenerated mock type for the MockPoolIface type
type MockPoolIface struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, sql, args
func (_m *MockPoolIface) Exec(ctx context.Context, sql string, args ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_m *MockPoolIface) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *MockPoolIface) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
// NewMockPoolIface creates a new instance of MockPoolIface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockPoolIface(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockPoolIface {
	mock := &MockPoolIface{}
